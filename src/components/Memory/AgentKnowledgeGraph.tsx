    ...
    <div className="relative w-full h-full bg-[#0d0d14] overflow-hidden border border-border">
      ...
      <div className="absolute top-3 left-3 right-3 flex items-center justify-between pointer-events-none">
        ...
        <div className="flex items-center gap-1 pointer-events-auto">
          <button onClick={() => zoom(1.25)} className="p-1.5 bg-black/50 border border-white/10 text-white/60 hover:text-white transition-colors">
            <ZoomIn className="w-3.5 h-3.5" />
          </button>
          <button onClick={() => zoom(0.8)} className="p-1.5 bg-black/50 border border-white/10 text-white/60 hover:text-white transition-colors">
            <ZoomOut className="w-3.5 h-3.5" />
          </button>
          <button onClick={resetView} className="p-1.5 bg-black/50 border border-white/10 text-white/60 hover:text-white transition-colors">
            <Maximize2 className="w-3.5 h-3.5" />
          </button>
          <button onClick={loadData} className="p-1.5 bg-black/50 border border-white/10 text-white/60 hover:text-white transition-colors">
          ...
          {panelNode.meta?.editable && (
            <div className="flex items-center justify-between px-4 py-3 border-t border-border shrink-0">
              ...
              <button
                ...
                className="ml-auto flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-primary/10 border border-primary/30 text-primary hover:bg-primary/20 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
